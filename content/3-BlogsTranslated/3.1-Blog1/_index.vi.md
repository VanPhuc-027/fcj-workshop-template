...
* **Phân loại mức độ rủi ro:** Hệ thống tự động ưu tiên xử lý dựa trên tầm quan trọng của tài nguyên. 
    > **Ví dụ:** Việc rò rỉ thông tin đăng nhập database *Production* sẽ ngay lập tức kích hoạt lệnh xoay vòng (rotate secret), trong khi các API key ở môi trường *Development* sẽ được xếp lịch xử lý sau.
...
---
*Chi tiết về cấu hình và các bước thiết lập kỹ thuật, có thể tham khảo thêm tại bài viết gốc trên AWS APN Blog:* 🔗 [Unified Secrets Security with GitGuardian and AWS Secrets Manager](https://aws.amazon.com/vi/blogs/apn/unified-secrets-security-with-gitguardian-and-aws-secrets-manager/)